...
const Quiz = () => {
  ...
  const loadRandomQuestion = () => {
    ...
    const questions = {
      ...
      19: { text: '비닐 장갑은 어떻게 분류할까요?', options: ['일반쓰레기', '종이', '플라스틱', '비닐'] },
      ...
      24: { text: '플라스틱 담배 케이스는 어떻게 처리해야 할까요?', options: ['일반쓰레기', '종이', '플라스틱', '비닐'] },
      ...
      45: { text: '일회용 비닐 장갑은 어떻게 분류해야 할까요?', options: ['일반쓰레기', '종이', '플라스틱', '비닐'] },
      46: { text: '재활용이 불가능한 스티로폼은 어디에 버려야 할까요?', options: ['일반쓰레기', '종이', '플라스틱', '비닐'] },
      47: { text: '플라스틱 뚜껑이 달린 유리병은 어떻게 처리해야 할까요?', options: ['일반쓰레기', '종이', '플라스틱', '비닐'] },
